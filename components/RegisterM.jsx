...
export default function RegisterM({ params }) {
  useEffect(() => {
    const init = async () => {
...
const password2 = password1;
    ...
    try {
      ...
      setMessage(".. Registering New User please wait..");
      ...
      //console.log("feeeeeee---------------------------d back-->",feedback);
 ...
 <form onSubmit={handleSubmit}  >
      { // <!--Sign in section-->
        ...
        <div
          ...
          <p className="mb-0 mr-4 text-lg">News user?</p>
      ...
      {  //  <!-- Separator between social media sign in and email/password sign in -->
        ...
        <div className="relative mb-3" data-te-input-wrapper-init>
          <input
            type="text"
            onChange={(e) => {setFirstName(e.target.value);setError("");setMessage("")}}
        ...
        <div className="relative mb-3" data-te-input-wrapper-init>
          <input
            type="text"
            onChange={(e) => {setLastName(e.target.value);setError("");setMessage("")}}
  ...
  {  
     ...
     { //<!-- Password input -->
        ...
        <div className="relative mb-6" data-te-input-wrapper-init>
          <input
            onChange={(e) => {setPassword1(e.target.value); setError(""); setMessage("")}}
            type={passwordVisible ? 'text' : 'password'}
      ...
      data-te-ripple-init
      data-te-ripple-color="light"> Register
    </button>
        ...
        {  //  <!-- Register link -->
          ...
          <p className="mb-0 mt-2 pt-1 text-sm font-semibold">
            ...
            <Link  className="text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700"
             href={"/login"}>Login</Link>  <Link  className="text-green-400 transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700"
             href={"/forgot"}>
