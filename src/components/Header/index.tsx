...
function Header() {
  ...
  <div className="container mx-auto  flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
      <a className="mr-5 cursor-pointer hover:font-medium hover:text-blue-900 ">Saved</a>
      <a className="mr-5 cursor-pointer hover:font-medium hover:text-blue-900">Messages</a>
      <a className="mr-5 cursor-pointer hover:font-medium hover:text-blue-900">Notification</a>
      <a className="mr-5 cursor-pointer hover:font-medium hover:text-blue-900">My Adverts</a>
    </nav>
    <button className="inline-flex items-center  bg-blue-100 border-0 py-1 px-3 focus:outline-none hover:bg-blue-200 hover:text-blue-900 hover:font-medium rounded text-base mt-4 md:mt-0">Sell
